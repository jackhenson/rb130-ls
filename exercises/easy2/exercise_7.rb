...
# the members of a collection, passing each element and
# an arbitrary object (usually a collection) to the
# associated block. The value returned by the block is
# not used. The object that is passed to the block is
# defined as an argument to each_with_object; with each
# iteration, this object may be updated by the block.
# When iteration is complete, the final value of the
# object is returned.
...
# each_with_object should return the final value of the
# object.
