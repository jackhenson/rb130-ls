# The Enumerable#each_with_index method iterates over
# the members of a collection, passing each element
# and its index to the associated block. The value
# returned by the block is not used. each_with_index
...
# and an index number to the block. each_with_index
...
def each_with_index(arr)
  arr.inject(0) { |m, e| yield(e, m) ; m + 1 }
  arr
end
