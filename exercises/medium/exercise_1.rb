...
# Below we have a listening device. It lets us record
# something that is said and store it for later use.
# In general, this is how the device should be used:

# Listen for something, and if anything is said, record
# it for later use. If nothing is said, then do not
#   record anything.
...
# the most recent recording using a Device#play method.
